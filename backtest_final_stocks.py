...
import time
from config import final_select_5bad
...
def generate_results_universe(num_permutations:int, uni = "u3"):
    ...
    for month_name, month_list in months_dict.items():
        ...
        for month in month_list[:]:
            ...
            #print(month)
            selected_stocks = final_select_5bad[month]#[0] # accessing the j th portfolio 
...
if __name__ == "__main__":
    ...
    print(returns)
    # out_file = open('./Annual_Returns/annualized_returns-u3-5-exp.json', "w") 
